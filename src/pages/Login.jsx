...
export default function Login() {
  ...
  return (
    <div className="h-screen bg-red-900 flex items-center justify-center px-4">
          ...
          <div className="p-8 space-y-6">
              ...
              <>
                ...
                {isMobile ? (
                  <form onSubmit={handleEmailSubmit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      className="w-full py-4 px-6 font-semibold rounded-xl shadow-lg transition-all duration-200 transform bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-white shadow-orange-500/25 hover:shadow-orange-400/30 focus:ring-4 focus:ring-orange-400/30 hover:scale-[1.02] active:scale-[0.98]"
                    >
            ...
            {(showPasswordStep || !isMobile) && (
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                {/* Sign In Button with Back Option (Mobile Step 2) */}
                {(!isMobile || step === 2) && (
                  <div className="space-y-3">
                    ...
                    {isMobile && step === 2 && (
                      <button
                        type="button"
                        onClick={handleBack}
                        className="w-full py-3 px-6 font-medium rounded-xl border border-slate-600/50 text-slate-300 hover:bg-gray-800/60 transition-all duration-200"
                      >
                        <div className="flex items-center justify-center space-x-2">
                          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
