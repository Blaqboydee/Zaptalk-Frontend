  ...
  return (
    <div className="min-h-screen bg-gray-900 pt-16 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        {/* Header Section */}
        <div className=" mb-8">
          <p className="text-gray-400 pt-8">Manage your account settings and preferences</p>
        </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-3 p-4 bg-gray-900/50 rounded-lg border border-gray-700">
                        ...
                        <span className="text-white lg:font-medium lg:text-sm text-xs">{profile.name}</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-3 p-4 bg-gray-900/50 rounded-lg border border-gray-700">
                        ...
                        <span className="text-white break-all lg:text-sm text-xs">{profile.email}</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-start space-x-3 p-4 bg-gray-900/50 rounded-lg border border-gray-700">
                        ...
                        <span className="text-gray-300 italic break-words lg:text-sm text-xs">"{profile.bioStatus}"</span>
                      </div>
                    </div>
                  </div>
                ) : (
